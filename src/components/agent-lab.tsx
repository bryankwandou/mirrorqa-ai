...
export function AgentLab() {
  ...
  async function runAgent() {
    ...
    try {
      ...
      if (!response.ok) throw new Error(data.error || "The model decision failed.");
    ...
    } catch (reason) { setError(reason instanceof Error ? reason.message : "The model decision failed."); }
